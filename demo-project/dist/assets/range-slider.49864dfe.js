import{m as J,u as K,V as Q,a as A,g as N}from"./VSliderTrack.94fe4778.js";import{b as X,m as Z,u as ee,f as le,V as ae,a as te}from"./VInput.1239432e.js";import{a0 as se,k as b,ae as oe,B as W,a6 as ue,p as a,F as ne,O as re,o as S,b as R,q as x,D,w as r,y as ie,m as i,E as d}from"./index.7cf7c61e.js";import{_ as de}from"./AppCardCode.d75a1d26.js";import{a as $,V as ce}from"./VRow.ff0250fc.js";import"./index.c48d7475.js";import"./router.3438bc48.js";import"./VImg.d72fefbf.js";import"./vue.runtime.esm-bundler.021ffa3e.js";import"./VCard.2337b864.js";import"./VAvatar.4f19170c.js";import"./position.bc69640e.js";import"./VBtn.173f27d7.js";import"./VDivider.be3199b8.js";const y=se({name:"VRangeSlider",props:{...X(),...Z(),...J(),strict:Boolean,modelValue:{type:Array,default:()=>[0,0]}},emits:{"update:focused":t=>!0,"update:modelValue":t=>!0},setup(t,s){let{slots:u}=s;const e=b(),l=b(),k=b();function h(n){if(!e.value||!l.value)return;const m=N(n,e.value.$el,t.direction),_=N(n,l.value.$el,t.direction),p=Math.abs(m),v=Math.abs(_);return p<v||p===v&&m<0?e.value.$el:l.value.$el}const{activeThumbRef:c,hasLabels:C,max:F,min:P,mousePressed:Y,onSliderMousedown:q,onSliderTouchstart:E,position:j,roundValue:G,trackContainerRef:H}=K({props:t,handleSliderMouseUp:n=>{var m;o.value=c.value===((m=e.value)==null?void 0:m.$el)?[n,o.value[1]]:[o.value[0],n]},handleMouseMove:n=>{var m;const[_,p]=o.value;if(!t.strict&&_===p&&_!==P.value){var v,V,f;c.value=n>_?(v=l.value)==null?void 0:v.$el:(V=e.value)==null?void 0:V.$el,(f=c.value)==null||f.focus()}c.value===((m=e.value)==null?void 0:m.$el)?o.value=[Math.min(n,p),p]:o.value=[_,Math.max(_,n)]},getActiveThumb:h}),o=oe(t,"modelValue",void 0,n=>!n||!n.length?[0,0]:n.map(m=>G(m))),{isFocused:M,focus:I,blur:z}=ee(t),L=W(()=>j(o.value[0])),O=W(()=>j(o.value[1]));return ue(()=>{const[n,m]=le(t),_=!!(t.label||u.label||u.prepend);return a(te,re({class:["v-slider","v-range-slider",{"v-slider--has-labels":!!u["tick-label"]||C.value,"v-slider--focused":M.value,"v-slider--pressed":Y.value,"v-slider--disabled":t.disabled}],ref:k},n,{focused:M.value}),{...u,prepend:_?p=>{var f;var v,V;return a(ne,null,[((f=(v=u.label)==null?void 0:v.call(u,p))!=null?f:t.label)?a(ae,{class:"v-slider__label",text:t.label},null):void 0,(V=u.prepend)==null?void 0:V.call(u,p)])}:void 0,default:p=>{var v,V;let{id:f}=p;return a("div",{class:"v-slider__container",onMousedown:q,onTouchstartPassive:E},[a("input",{id:`${f.value}_start`,name:t.name||f.value,disabled:t.disabled,readonly:t.readonly,tabindex:"-1",value:o.value[0]},null),a("input",{id:`${f.value}_stop`,name:t.name||f.value,disabled:t.disabled,readonly:t.readonly,tabindex:"-1",value:o.value[1]},null),a(Q,{ref:H,start:L.value,stop:O.value},{"tick-label":u["tick-label"]}),a(A,{ref:e,focused:M&&c.value===((v=e.value)==null?void 0:v.$el),modelValue:o.value[0],"onUpdate:modelValue":g=>o.value=[g,o.value[1]],onFocus:g=>{var T,w;if(I(),c.value=(T=e.value)==null?void 0:T.$el,o.value[0]===o.value[1]&&o.value[1]===P.value&&g.relatedTarget!==((w=l.value)==null?void 0:w.$el)){var U,B;(U=e.value)==null||U.$el.blur(),(B=l.value)==null||B.$el.focus()}},onBlur:()=>{z(),c.value=void 0},min:P.value,max:o.value[1],position:L.value},{"thumb-label":u["thumb-label"]}),a(A,{ref:l,focused:M&&c.value===((V=l.value)==null?void 0:V.$el),modelValue:o.value[1],"onUpdate:modelValue":g=>o.value=[o.value[0],g],onFocus:g=>{var T,w;if(I(),c.value=(T=l.value)==null?void 0:T.$el,o.value[0]===o.value[1]&&o.value[0]===F.value&&g.relatedTarget!==((w=e.value)==null?void 0:w.$el)){var U,B;(U=l.value)==null||U.$el.blur(),(B=e.value)==null||B.$el.focus()}},onBlur:()=>{z(),c.value=void 0},min:o.value[0],max:F.value,position:O.value},{"thumb-label":u["thumb-label"]})])}})}),{}}}),me={__name:"DemoRangeSliderVertical",setup(t){const s=b([20,40]);return(u,e)=>(S(),R(y,{modelValue:x(s),"onUpdate:modelValue":e[0]||(e[0]=l=>D(s)?s.value=l:null),direction:"vertical"},null,8,["modelValue"]))}},pe={__name:"DemoRangeSliderThumbLabel",setup(t){const s=["Winter","Spring","Summer","Fall"],u=["tabler-snowflake","tabler-leaf","tabler-flame","tabler-droplet"],e=b([1,2]);return(l,k)=>(S(),R(y,{modelValue:x(e),"onUpdate:modelValue":k[0]||(k[0]=h=>D(e)?e.value=h:null),tick:s,min:"0",max:"3",step:1,"show-ticks":"always","thumb-label":"","tick-size":"4"},{"thumb-label":r(({modelValue:h})=>[a(ie,{icon:u[h]},null,8,["icon"])]),_:1},8,["modelValue"]))}},ve={__name:"DemoRangeSliderStep",setup(t){const s=b([20,40]);return(u,e)=>(S(),R(y,{modelValue:x(s),"onUpdate:modelValue":e[0]||(e[0]=l=>D(s)?s.value=l:null),step:"10"},null,8,["modelValue"]))}},fe={__name:"DemoRangeSliderColor",setup(t){const s=b([10,60]);return(u,e)=>(S(),R(y,{modelValue:x(s),"onUpdate:modelValue":e[0]||(e[0]=l=>D(s)?s.value=l:null),color:"success","track-color":"secondary"},null,8,["modelValue"]))}},_e={__name:"DemoRangeSliderDisabled",setup(t){const s=b([30,60]);return(u,e)=>(S(),R(y,{modelValue:x(s),"onUpdate:modelValue":e[0]||(e[0]=l=>D(s)?s.value=l:null),disabled:"",label:"Disabled"},null,8,["modelValue"]))}},be={__name:"DemoRangeSliderBasic",setup(t){const s=b([10,60]);return(u,e)=>(S(),R(y,{modelValue:x(s),"onUpdate:modelValue":e[0]||(e[0]=l=>D(s)?s.value=l:null)},null,8,["modelValue"]))}},Ve={ts:`<script setup lang="ts">
